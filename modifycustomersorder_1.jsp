...
<%
  ...
  try{
      ...
      st=conn.createStatement();
       ...
       String quer="SELECT * FROM minupage where id="+ir;
      ResultSet rs = st.executeQuery(quer);
      
      
   %>
   <form method="post" action="viewallcustomersorder.jsp">
 ...
 %>
          ...
          <td>Enter your Phone Number</td>
                <td><input type="text" value="<%=rs.getString("gmai")%>" name="gmai"></td>
      </tr><tr>
                <td>Restaurant Name</td>
                <td><input type="text" value="<%=rs.getString("rn")%>" name="rn"></td>
      </tr><tr>  
                <td>Food Name</td>
                <td><input type="text" value="<%=rs.getString("fn")%>" name="fn"></td>
      </tr><tr> 
        
          <td>Price of food</td>
           <td><input type="text" value="<%=rs.getString("pf")%>" name="pf"></td>
      </tr> 
      ...
      <tr>  
                <td>Address</td>
                <td><input type="text" value="<%=rs.getString("ad")%>" name="ad"></td>
      </tr>
      <%  }  %>    <tr>
