...
<%
  ...
  try{
      ...
      String query="insert into RestaurantMaster(Name,passord,email,mobile,city)values('"+name+"','"+passord+"','"+email+"','"+mobile+"','"+city+"')";
...
<form method="post" action="viewallcourse.jsp">
    <center><h1>NEW RESTAURANT CREATED SUCCESSFULLY</h1></center>
