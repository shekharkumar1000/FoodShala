...
<%
  ...
  try{
      ...
      String query="delete from RestaurantMaster where id="+ kd;
      int result=st.executeUpdate(query);
      
   %> 
   <center><H1><br><br><b> RESTAURANT DELETED SUCCESSFULLY</b></H1></center>
  <%    
  }
   catch(Exception e){
%>
 <link rel="stylesheet" href="css.css"/>
              <table Id="course-table" align="center">
               <div id="course-table">
                   <center><h3>This Restaurant is already enrolled </h3></center>
               </div>
              </table>
<%
}
