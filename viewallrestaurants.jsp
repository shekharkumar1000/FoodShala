...
<%
  ...
  try{
     ...
     String city=request.getParameter("city");
       String qq="Update RestaurantMaster set id="+id+" where id="+id+" ;";
        int resu = st.executeUpdate(qq);
        String r="Update RestaurantMaster set name='"+name+"' where id="+id+" ;";
        int rer = st.executeUpdate(r);
        String up="Update RestaurantMaster set passord='"+passord+"' where id="+id+" ;";
         int rr = st.executeUpdate(up);
        String uup="Update RestaurantMaster set email='"+email+"' where id="+id+" ;";
        int ry = st.executeUpdate(uup);
        String qqr="Update RestaurantMaster set mobile='"+mobile+"' where id="+id+" ;";
        int restu = st.executeUpdate(qqr);
          String sk="Update RestaurantMaster set city='"+city+"' where id="+id+" ;";
